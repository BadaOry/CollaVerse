...
VALUES(FOLLOWING_NO_SEQ.NEXTVAL, 1, 21, DEFAULT, 1);

INSERT INTO FOLLOWER(FOLLOWER_NO, TO_MEM_NO, FROM_MEM_NO, FOLLOWER_CREATE_DATE, FOLLOWERCHECK)
VALUES(FOLLOWER_NO_SEQ.NEXTVAL, 21, 1, DEFAULT, 1);

-- 02. 2번 회원이 21번 회원을 팔로우
INSERT INTO FOLLOWING(FOLLOWING_NO, FROM_MEM_NO, TO_MEM_NO, FOLLOWING_CREATE_DATE, FOLLOWINGCHECK)
VALUES(FOLLOWING_NO_SEQ.NEXTVAL, 2, 21, DEFAULT, 1);

INSERT INTO FOLLOWER(FOLLOWER_NO, TO_MEM_NO, FROM_MEM_NO, FOLLOWER_CREATE_DATE, FOLLOWERCHECK)
VALUES(FOLLOWER_NO_SEQ.NEXTVAL, 21, 2, DEFAULT, 1);

-- 04. 3번 회원이 21번 회원을 팔로우
INSERT INTO FOLLOWING(FOLLOWING_NO, FROM_MEM_NO, TO_MEM_NO, FOLLOWING_CREATE_DATE, FOLLOWINGCHECK)
VALUES(FOLLOWING_NO_SEQ.NEXTVAL, 3, 21, DEFAULT, 1);

INSERT INTO FOLLOWER(FOLLOWER_NO, TO_MEM_NO, FROM_MEM_NO, FOLLOWER_CREATE_DATE, FOLLOWERCHECK)
VALUES(FOLLOWER_NO_SEQ.NEXTVAL, 21, 3, DEFAULT, 1);

-- 04. 21번 회원이 41번 두두링 회원을 팔로우
INSERT INTO FOLLOWING(FOLLOWING_NO, FROM_MEM_NO, TO_MEM_NO, FOLLOWING_CREATE_DATE, FOLLOWINGCHECK)
VALUES(FOLLOWING_NO_SEQ.NEXTVAL, 21, 41, DEFAULT, 1);

INSERT INTO FOLLOWER(FOLLOWER_NO, TO_MEM_NO, FROM_MEM_NO, FOLLOWER_CREATE_DATE, FOLLOWERCHECK)
VALUES(FOLLOWER_NO_SEQ.NEXTVAL, 41, 21, DEFAULT, 1);

-- 05. 21번 회원이 1번 관리자 회원을 팔로우
INSERT INTO FOLLOWING(FOLLOWING_NO, FROM_MEM_NO, TO_MEM_NO, FOLLOWING_CREATE_DATE, FOLLOWINGCHECK)
VALUES(FOLLOWING_NO_SEQ.NEXTVAL, 21, 1, DEFAULT, 1);

INSERT INTO FOLLOWER(FOLLOWER_NO, TO_MEM_NO, FROM_MEM_NO, FOLLOWER_CREATE_DATE, FOLLOWERCHECK)
VALUES(FOLLOWER_NO_SEQ.NEXTVAL, 1, 21, DEFAULT, 1);
...
-- 07. 21번 회원이 41번 두두링 회원을 팔로우하는지 확인
			SELECT COUNT(*)
			FROM FOLLOWING
			WHERE FROM_MEM_NO = 21
    			AND TO_MEM_NO = 41
