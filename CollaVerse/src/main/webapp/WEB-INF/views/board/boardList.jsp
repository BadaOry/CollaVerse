...
<%@ include file="/WEB-INF/views/common/header.jsp" %>
	...
	<nav aria-label="...">	
	  <ul class="pagination justify-content-center">
	  	<li class="page-item">
	      <a href="${ path }/board/boardList?page=1" class="page-link">&lt;&lt;</a>
	    </li>
	    <li class="page-item">
	      <a href="${ path }/board/boardList?page=${ pageInfo.prevPage }" class="page-link">&lt;</a>
	    </li>
	    ...
	    <c:forEach begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" varStatus="status">
				...
				<c:if test="${ status.current != pageInfo.currentPage }">
					<li class="page-item" ><a class="page-link" href="${ path }/board/boardList?page=${ status.current }&count=${ pageInfo.listLimit }">${ status.current }</a></li>				
				</c:if>
		</c:forEach>
	    
	    <li class="page-item">
	      <a href="${ path }/board/boardList?page=${ pageInfo.nextPage }" class="page-link" >&gt;</a>
	    </li>
	    <li class="page-item">
	      <a href="${ path }/board/boardList?page=${ pageInfo.maxPage }" class="page-link" >&gt;&gt;</a>
	    </li>
	  </ul>
	</nav>
