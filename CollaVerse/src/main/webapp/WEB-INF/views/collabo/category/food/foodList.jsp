...
<body>
   ...
   <div class="frame">
    ...
    <div class="living">
        <div id="area1">
            <div class="p_img">
                 <img src="${ pageContext.request.contextPath }/resources/images/promotion/promotion7.jpg" width="470px" height="350px">
            </div>
            <p>
            <p>프로모션 타이틀</p>
            <p>프로모션 설명</p>
        ...
        <div id="area2">
            <div class="p_img">
                <img src="${ pageContext.request.contextPath }/resources/images/promotion/promotion8.jpg" width="470px" height="350px">
            </div>
            <p>
            <p>프로모션 타이틀</p>
            <p>프로모션 설명</p>
        ...
        <div id="area3">
            <div class="p_img">
                <img src="${ pageContext.request.contextPath }/resources/images/promotion/promotion9.jpg" width="470px" height="350px">
            </div>
            <p>
            <p>프로모션 타이틀</p>
            <p>프로모션 설명</p>
