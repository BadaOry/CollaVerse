				...
				<span class="form-group">
						...
						<c:if test="${ !empty qna }">
	   						<c:forEach items="${ qna }" var="list">
		   						<tr>
					                ...
					                <td><span class="badge bg-red">${ list.readCount }</span></td>
					            </tr>
	   						</c:forEach>
   						</c:if>
   						</tbody>
   				...
   				<div class="card-footer">
   					<div class="float-right">
   						<button type="button" onclick="location.href='${ path }/qna/enroll'" class="btn btn-success btn-flat" id="writeBtn">
...
function Change(idx){
    ...
    if(nowPaging == 5){
        location.href="${path}/qna/optionList/optionList5";    
    }else if(nowPaging == 10){
        location.href="${path}/qna/optionList/optionList10";    
    }else if(nowPaging == 20){
        location.href="${path}/qna/optionList/optionList20";    
    }else if(nowPaging == 30){
        location.href="${path}/qna/optionList/optionList30";    
    }else if(nowPaging == 40){
        location.href="${path}/qna/optionList/optionList40";    
    }
}
...
$(document).ready(function(){
	...
	$(".move").on("click", function(e){
		...
		moveForm.attr("action", "${ path }/board/get");
		moveForm.submit();
	});
	...
	$(".pageInfo a").on("click", function(e){
	    ...
	    moveForm.attr("action", "${ path }/board/list");
	    moveForm.submit();
